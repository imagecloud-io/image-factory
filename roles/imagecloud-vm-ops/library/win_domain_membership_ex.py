...
options:
  ...
  ou_path:
    description:
      - specify the DN of the OU the host needs to be joined to, when joining a domain. It is not used when joining a
        workgroup, nor is it checked when the host is already member of the domain.
  hostname:
    description:
